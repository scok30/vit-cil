...
def load_first_task_model(model_without_ddp, loss_scaler, task_id, args, **kwargs):
    strict = False
    ...
    if args.resume.startswith('https'):
        ...
        path = os.path.join(args.resume, f"checkpoint_{3}.pth")
        if 'path' in kwargs:path = kwargs['path']
